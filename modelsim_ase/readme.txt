...
For VHDL designs, to map to the VHDL-1987 precompiled libraries for 
simulating HDL designs using apex20ke primitives or post-layout
simulation netlist, use the following command:

  vmap apex20ke <ModelSim-Altera install directory>/altera/vhdl/apex20ke_87
...
1.  Change directory to the <cdrom_directory>/modelsim/pc/ 
    directory
2.  Run the self-extracting executable ModelSim-Altera.exe

	NOTE: If a dialog box appears at the beginning
	of the installation that asks about overwriting a 
	file in C:\TEMP, select "Yes To All".  
...
Installing ModelSim-Altera edition on solaris and linux workstations
====================================================================

1.  Change directory to the <cdrom_directory>/modelsim/unix/
    directory.
2.  Type 'install.ms' and follow the instructions on screen.
...
2. The installation contains both VHDL-1987 and VHDL-1993 pre-compiled 
   libraries for APEX 20KE family, LPMs (220model), and megafunctions 
   ...
   vmap apex20ke $(MODEL_TECH)/../altera/vhdl/apex20ke_87
